...
async def main():
    ...
    while True:
        ...
        if VARIABLES == None:
            ...
            BALL_CONFIGS = [{'x': VARIABLES['x'],'y': VARIABLES['y'],'vx': VARIABLES['vx'],'vy': VARIABLES['vy'],'ax': VARIABLES['ax'],
                 'ay': VARIABLES['ay'],'mass': VARIABLES['mass'],'radius': VARIABLES['radius'],'elasticity': VARIABLES['elasticity'],
