...
def process_physics_response(problem):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": "I need you to make another section just for variables starting with 'Variables:', exactly like this, and what they are equal too, so all the variables at the end the solution. Any variable to do with the equation. Create a list of dictionaries containing variable about position, velocity, and acceleration in the x and y directions as well as mass and radius (elasticity and friction if required). The format is [{'x': 400, 'y': 100,'vx': 500, 'vy': 0, 'ax': 0, 'ay': 0, 'elasticity': 0, 'friction': 0, 'mass': 0, 'radius': 0}]. Anything that is neglible make them realistic for the sake of the simulation. DO NOT leave comments."},
